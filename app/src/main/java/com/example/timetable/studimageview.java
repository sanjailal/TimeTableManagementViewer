...
//import static com.example.timetable.studentview.rsmon1;

public class studimageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studimageview);
        Bundle extras;
